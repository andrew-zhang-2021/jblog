  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jblogApp.entry.home.createOrEditLabel" data-cy="EntryCreateUpdateHeading">
            <Translate contentKey="jblogApp.entry.home.createOrEditLabel">Create or edit a Entry</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jblogApp.entry.title')}
                id="entry-title"
                name="title"
                data-cy="title"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jblogApp.entry.content')}
                id="entry-content"
                name="content"
                data-cy="content"
                type="textarea"
              ...
              />
              <ValidatedField
                label={translate('jblogApp.entry.date')}
                id="entry-date"
                name="date"
                data-cy="date"
                type="datetime-local"
              ...
              />
              <ValidatedField id="entry-blog" name="blogId" data-cy="blog" label={translate('jblogApp.entry.blog')} type="select">
                <option value="" key="0" />
                {blogs
              ...
              <ValidatedField label={translate('jblogApp.entry.tag')} id="entry-tag" data-cy="tag" type="select" multiple name="tags">
                <option value="" key="0" />
                {tags
