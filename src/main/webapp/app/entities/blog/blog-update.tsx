  ...
  return (
    <div>
      <Row className="justify-content-center">
        <Col md="8">
          <h2 id="jblogApp.blog.home.createOrEditLabel" data-cy="BlogCreateUpdateHeading">
            <Translate contentKey="jblogApp.blog.home.createOrEditLabel">Create or edit a Blog</Translate>
          </h2>
        </Col>
      </Row>
      <Row className="justify-content-center">
        <Col md="8">
          {loading ? (
            ...
            <ValidatedForm defaultValues={defaultValues()} onSubmit={saveEntity}>
              ...
              <ValidatedField
                label={translate('jblogApp.blog.name')}
                id="blog-name"
                name="name"
                data-cy="name"
                type="text"
              ...
              />
              <ValidatedField
                label={translate('jblogApp.blog.handle')}
                id="blog-handle"
                name="handle"
                data-cy="handle"
                type="text"
              ...
              />
              <ValidatedField id="blog-user" name="userId" data-cy="user" label={translate('jblogApp.blog.user')} type="select">
                <option value="" key="0" />
                {users
