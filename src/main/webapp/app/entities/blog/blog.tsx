  ...
  return (
    <div>
      <h2 id="blog-heading" data-cy="BlogHeading">
        <Translate contentKey="jblogApp.blog.home.title">Blogs</Translate>
        <div className="d-flex justify-content-end">
          <Button className="mr-2" color="info" onClick={handleSyncList} disabled={loading}>
            <FontAwesomeIcon icon="sync" spin={loading} />{' '}
            <Translate contentKey="jblogApp.blog.home.refreshListLabel">Refresh List</Translate>
          </Button>
          <Link to={`${match.url}/new`} className="btn btn-primary jh-create-entity" id="jh-create-entity" data-cy="entityCreateButton">
            <FontAwesomeIcon icon="plus" />
            &nbsp;
            <Translate contentKey="jblogApp.blog.home.createLabel">Create new Blog</Translate>
          </Link>
        </div>
      </h2>
        ...
        {blogList && blogList.length > 0 ? (
          <Table responsive>
            <thead>
              <tr>
                <th>
                  <Translate contentKey="jblogApp.blog.id">ID</Translate>
                </th>
                <th>
                  <Translate contentKey="jblogApp.blog.name">Name</Translate>
                </th>
                <th>
                  <Translate contentKey="jblogApp.blog.handle">Handle</Translate>
                </th>
                <th>
                  <Translate contentKey="jblogApp.blog.user">User</Translate>
                </th>
                <th />
              </tr>
            </thead>
          ...
          !loading && (
            <div className="alert alert-warning">
              <Translate contentKey="jblogApp.blog.home.notFound">No Blogs found</Translate>
            </div>
          )
        )}
      </div>
